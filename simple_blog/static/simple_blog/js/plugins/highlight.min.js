...
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);hljs.registerLanguage("less",(()=>{"use strict"
...
name:"Less",case_insensitive:!0,illegal:"[=>'/<($\"]",contains:c}}})());hljs.registerLanguage("typescript",(()=>{"use strict"
...
end:"$",illegal:"\n"},o]}}})());hljs.registerLanguage("ini",(()=>{"use strict";function e(e){
...
starts:{end:/$/,contains:[t,l,r,i,c,a]}}]}}})());hljs.registerLanguage("python",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(...n){
...
className:"meta",begin:/^[\t ]*@/,end:/(?=#)|$/,contains:[b,p,o]}]}}})());hljs.registerLanguage("java",(()=>{"use strict"
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},n,r]}}})());hljs.registerLanguage("bash",(()=>{"use strict";function e(...e){
...
},{className:"string",begin:/'/,end:/'/},n]}}})());hljs.registerLanguage("perl",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(...n){
...
contains:[e.UNDERSCORE_TITLE_MODE]},l,s]}}})());hljs.registerLanguage("shell",(()=>{"use strict";return s=>({
name:"Shell Session",aliases:["console","shellsession"],contains:[{
className:"meta",begin:/^\s{0,3}[/~\w\d[\]()@-]*[>%$#][ ]?/,starts:{
end:/[^\\](?=\s*$)/,subLanguage:"bash"}}]})})());hljs.registerLanguage("go",(()=>{"use strict";return e=>{const n={
...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})());hljs.registerLanguage("plaintext",(()=>{"use strict";return t=>({
...
},...B,..._,...M,I,P,...z,...q,U,V]}}})());hljs.registerLanguage("css",(()=>{"use strict"
...
begin:"\\b("+e.join("|")+")\\b"}]};var s}})());hljs.registerLanguage("diff",(()=>{"use strict";function e(...e){
...
end:/$/}]})})());hljs.registerLanguage("scss",(()=>{"use strict"
...
className:"variable.constant"},R,k,{match:/\$[(.]/}]}}})());hljs.registerLanguage("markdown",(()=>{"use strict";function n(...n){
...
skip:!0})]}]})})());hljs.registerLanguage("c",(()=>{"use strict";function e(e){
...
strings:i,keywords:u}}}})());hljs.registerLanguage("python-repl",(()=>{"use strict";return s=>({
aliases:["pycon"],contains:[{className:"meta",starts:{end:/ |$/,starts:{end:"$",
subLanguage:"python"}},variants:[{begin:/^>>>(?=[ ]|$)/},{
begin:/^\.\.\.(?=[ ]|$)/}]}]})})());hljs.registerLanguage("r",(()=>{"use strict";function e(...e){return"("+((e=>{
const n=e[e.length-1]
;return"object"==typeof n&&n.constructor===Object?(e.splice(e.length-1,1),n):{}
})(e).capture?"":"?:")+e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null
;var n})).join("|")+")"}return n=>{
...
contains:[{begin:/\\./}]}]}}})());hljs.registerLanguage("rust",(()=>{"use strict";function e(...e){
...
relevance:0}]}}})());hljs.registerLanguage("lua",(()=>{"use strict";return e=>{
...
begin:t,end:a,contains:[n],relevance:5}])}}})());hljs.registerLanguage("json",(()=>{"use strict";return e=>({name:"JSON",
